const input_m = document.querySelector("#input_m");
const h3_meterCmCon = document.querySelector("#h3_meterCmCon");
const h3_meterKilometerCon = document.querySelector("#h3_meterKilometerCon");
...
function meter_handleKilometerChange() {
    if (input_m instanceof HTMLInputElement) {
